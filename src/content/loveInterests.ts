...
export const LOVE_INTERESTS: Record<LoveInterestId, LoveInterest> = {
  ...
  widow: {
    ...
    acclaim: 0,
    deference: 1,
    introScene: { sceneId: 'romance_widow_intro' },
  ...
  sole_heir: {
    ...
    acclaim: 0,
    deference: 1,
    introScene: { sceneId: 'romance_sole_heir_intro' },
  ...
  captain: {
    ...
    acclaim: 1,
    deference: 0,
    introScene: { sceneId: 'romance_captain_intro' },
  ...
  devotee: {
    ...
    acclaim: -1,
    deference: 1,
    introScene: { sceneId: 'romance_devotee_intro' },
  ...
  second_prince: {
    ...
    acclaim: -1,
    deference: 1,
    introScene: { sceneId: 'romance_second_prince_intro' },
    criticalChoice: { sceneId: 'romance_second_prince_critical', stage: 4 },
    valuedTags: ['principle', 'grace'],
    tastes: ['moon', 'pine', 'cherry_blossom', 'maple'],
    kanzashiAffinity: 'grace',
  ...
  merchant: {
    ...
    acclaim: 1,
    deference: -1,
    introScene: { sceneId: 'romance_merchant_intro' },
    criticalChoice: { sceneId: 'romance_merchant_critical', stage: 2 },
    valuedTags: ['alignment', 'grace'],
    tastes: ['insects', 'plover'],
    kanzashiAffinity: 'alignment',
